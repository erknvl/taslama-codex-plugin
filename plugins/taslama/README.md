...
Taslama подключает Codex к выбранному проекту через OAuth. Плагин помогает магазинам и сервисным компаниям управлять каталогом, медиа, сотрудниками, клиентами, записями, заказами, лендингом и настройками сайта без локального хранения API-ключей и ID проекта. В открытой административной панели поддерживаемые клиенты также получают контекстные WebMCP-инструменты.
...
- Контекстные WebMCP-инструменты административной панели для заказов, оплат, возвратов, остатков, посадочной и загрузки медиа по HTTPS
